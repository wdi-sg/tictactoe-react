...
/* harmony import */ var _style_scss__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(14);
...
/* harmony import */ var _components_board_board__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(12);
...
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(2);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var _button_jsx__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(13);
function _typeof(obj) {if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") {_typeof = function _typeof(obj) {return typeof obj;};} else {_typeof = function _typeof(obj) {return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj;};}return _typeof(obj);}function _classCallCheck(instance, Constructor) {if (!(instance instanceof Constructor)) {throw new TypeError("Cannot call a class as a function");}}function _defineProperties(target, props) {for (var i = 0; i < props.length; i++) {var descriptor = props[i];descriptor.enumerable = descriptor.enumerable || false;descriptor.configurable = true;if ("value" in descriptor) descriptor.writable = true;Object.defineProperty(target, descriptor.key, descriptor);}}function _createClass(Constructor, protoProps, staticProps) {if (protoProps) _defineProperties(Constructor.prototype, protoProps);if (staticProps) _defineProperties(Constructor, staticProps);return Constructor;}function _possibleConstructorReturn(self, call) {if (call && (_typeof(call) === "object" || typeof call === "function")) {return call;}return _assertThisInitialized(self);}function _assertThisInitialized(self) {if (self === void 0) {throw new ReferenceError("this hasn't been initialised - super() hasn't been called");}return self;}function _getPrototypeOf(o) {_getPrototypeOf = Object.setPrototypeOf ? Object.getPrototypeOf : function _getPrototypeOf(o) {return o.__proto__ || Object.getPrototypeOf(o);};return _getPrototypeOf(o);}function _inherits(subClass, superClass) {if (typeof superClass !== "function" && superClass !== null) {throw new TypeError("Super expression must either be null or a function");}subClass.prototype = Object.create(superClass && superClass.prototype, { constructor: { value: subClass, writable: true, configurable: true } });if (superClass) _setPrototypeOf(subClass, superClass);}function _setPrototypeOf(o, p) {_setPrototypeOf = Object.setPrototypeOf || function _setPrototypeOf(o, p) {o.__proto__ = p;return o;};return _setPrototypeOf(o, p);}
var
...
Board = /*#__PURE__*/function (_React$Component) {_inherits(Board, _React$Component);
  ...
  function Board() {var _this;_classCallCheck(this, Board);
    ...
    } }, { key: "squareClick", value: function squareClick(
    ...
    col, row) {
      ...
      var length = this.state.board.length;
      var tempBoard = this.state.board;
      var clickState = this.state.click;
      var matchCount = 0;
      var xWin = this.state.playerOneScore;
      var oWin = this.state.playerTwoScore;
      ...
      if (this.state.board[row][col] == null && this.state.turn != 'Game Ended!' && this.state.turn != 'UwU') {
        ...
        var num = this.state.click + 1;
        if (this.state.click == 8) {
          this.state.turn = 'Game Ended!';
          this.state.text = react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row border left-align", style: { padding: '7px 15px 8px 15px', width: '300px' } }, "It's a draw!");
        }
        var updateObj = {
          click: num };
      ...
      if (xWin > this.state.playerOneScore) {
        this.setState({
          playerOneScore: xWin,
          turn: 'Game Ended!',
          text: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row border left-align", style: { padding: '7px 15px 8px 15px', width: '300px' } }, "Congratulations Player One !") });
      ...
      if (oWin > this.state.playerTwoScore) {
        this.setState({
          playerTwoScore: oWin,
          turn: 'Game Ended!',
          text: react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row border left-align", style: { padding: '7px 15px 8px 15px', width: '300px' } }, "Congratulations Player Two !") });

      }
      console.log(matchCount);
    } }, { key: "onBoardSize", value: function onBoardSize()
    ...
    {var _this2 = this;
      ...
      var board = this.state.board.map(function (row, rowIndex) {
        ...
        // make a single row
        var rows = row.map(function (col, colIndex) {
          ...
          return (
            ...
            _this2.state.board[rowIndex][colIndex]));


        });

        return (
          react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { key: rowIndex, id: "board", className: "boxrow row" },
          rows));
      ...
      return (
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row center-align", style: { marginTop: '20px', padding: '0 20px' } },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "col s12 m3 border", style: { marginBottom: '5px' } },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "turn" }, this.state.turn)),

        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "col s12 m4 offset-m1 border", style: { marginBottom: '5px' } },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "turn", style: { padding: '0' } },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "col s6" },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { className: "btn-flat", onClick: function onClick() {
            _this2.play();} },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", { className: "material-icons small" }, "play_arrow"))),


        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "col s6" },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("button", { className: "btn-flat", onClick: function onClick() {
            _this2.refresh();} },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("i", { className: "material-icons small" }, "refresh"))))),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "col s12 m4 offset-m4" },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "score row border" },
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Scores"),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "divider" }),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Player One: ", this.state.playerOneScore),
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", null, "Player Two: ", this.state.playerTwoScore)))),
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "row center", style: { marginTop: '20px' } },
        this.state.text)));
...
Button = /*#__PURE__*/function (_React$Component) {_inherits(Button, _React$Component);function Button() {_classCallCheck(this, Button);return _possibleConstructorReturn(this, _getPrototypeOf(Button).apply(this, arguments));}_createClass(Button, [{ key: "componentDidMount", value: function componentDidMount()
    ...
    {
      return (
        react__WEBPACK_IMPORTED_MODULE_0___default.a.createElement("div", { className: "col s12 m3 offset-m1 border", style: { padding: '0px', marginBottom: '5px' } },
    ...
    } }]);return Button;}(react__WEBPACK_IMPORTED_MODULE_0___default.a.Component);
